...
public class CA2_HDip2_2025039_David_Gomez {
     ...
     * @param left   Left index of search interval
     * @param right  Right index of search interval
    ...
    public static class Employee {
        ...
        /**
         * Inserts a new node into the tree in level-order (breadth-first)
         *
        ...
        /**
         * Level-order traversal of the tree, printing all employee info
         */
            public void bfs() {
                if (root == null) return;
                Queue<TreeNode> q = new LinkedList<>();
            ...
            while (true) {
                ...
                switch (choice) {
                    ...
                    case 3:
                        ...
                        // Variables for manager and department
                        String dept = "";
                        String man = "";
                        // Operative menu
